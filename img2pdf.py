...
class MyPdfWriter:
    ...
    def tostream(self, info, stream, version="1.3", ident=None):
        ...
        #  > 3.1, â€œLexical Conventionsâ€), it is recommended that the header
        #  > line be immediately followed by a comment line containing at
        #  > least four binary charactersâ€”that is, characters whose codes are
        ...
        #  > determine whether to treat the fileâ€™s contents as text or as
        #  > binary.
        #
        ...
        #  > [...]
        #  >
        #  > If the fileâ€™s end-of-line marker is a single character (either a
